...
class Messageable:
    @overload
    async def send(self, content: Optional[str] = ..., *, tts: Optional[bool] = ..., embed: Optional[Embed] = ..., file: Optional[File] = ..., stickers: Optional[Sequence[Union[GuildSticker, StickerItem]]] = ..., delete_after: Optional[float] = ..., nonce: Optional[Union[str, int]] = ..., allowed_mentions: Optional[AllowedMentions] = ..., reference: Optional[Union[Message, MessageReference, PartialMessage]] = ..., mention_author: Optional[bool] = ..., view: Optional[View] = ...) -> Message: ...
    @overload
    async def send(self, content: Optional[str] = ..., *, tts: Optional[bool] = ..., embed: Optional[Embed] = ..., files: Optional[List[File]] = ..., stickers: Optional[Sequence[Union[GuildSticker, StickerItem]]] = ..., delete_after: Optional[float] = ..., nonce: Optional[Union[str, int]] = ..., allowed_mentions: Optional[AllowedMentions] = ..., reference: Optional[Union[Message, MessageReference, PartialMessage]] = ..., mention_author: Optional[bool] = ..., view: Optional[View] = ...) -> Message: ...
    @overload
    async def send(self, content: Optional[str] = ..., *, tts: Optional[bool] = ..., embeds: Optional[List[Embed]] = ..., file: Optional[File] = ..., stickers: Optional[Sequence[Union[GuildSticker, StickerItem]]] = ..., delete_after: Optional[float] = ..., nonce: Optional[Union[str, int]] = ..., allowed_mentions: Optional[AllowedMentions] = ..., reference: Optional[Union[Message, MessageReference, PartialMessage]] = ..., mention_author: Optional[bool] = ..., view: Optional[View] = ...) -> Message: ...
    @overload
    async def send(self, content: Optional[str] = ..., *, tts: Optional[bool] = ..., embeds: Optional[List[Embed]] = ..., files: Optional[List[File]] = ..., stickers: Optional[Sequence[Union[GuildSticker, StickerItem]]] = ..., delete_after: Optional[float] = ..., nonce: Optional[Union[str, int]] = ..., allowed_mentions: Optional[AllowedMentions] = ..., reference: Optional[Union[Message, MessageReference, PartialMessage]] = ..., mention_author: Optional[bool] = ..., view: Optional[View] = ...) -> Message: ...
