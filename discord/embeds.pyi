...
from typing import Any, Dict, Final, List, Mapping, Type, TypeVar, Union
...
class Embed:
    ...
    def set_footer(self: E, *, text: MaybeEmpty[Any] = ..., icon_url: MaybeEmpty[Any] = ...) -> E: ...
    ...
    def set_author(self: E, name: Any, *, url: MaybeEmpty[Any] = ..., icon_url: MaybeEmpty[Any] = ...) -> E: ...
