...
from typing import Dict, List, Literal, NamedTuple, Optional, Sequence, Tuple, Union, overload
...
class Guild(Hashable):
    ...
    def fetch_members(self, *, limit: int = ..., after: Optional[SnowflakeTime] = ...) -> MemberIterator: ...
